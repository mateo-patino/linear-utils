...
* member of this result_t will also point to an object in the heap that must 
* be freed by the caller. This object will be either a matrixv_t or scalar 
* struct from the linear algebra library. 
* 
* TODO: should we translate the result_t to another data structure
